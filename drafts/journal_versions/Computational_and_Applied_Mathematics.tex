% Initial-submission candidate for Computational and Applied Mathematics,
% 29 August 2026. Derived from the frozen-content local v4 candidate without
% changing any theorem, proof, computation, citation, author statement, or
% limitation. Uses Springer Nature's official sn-jnl template and the
% journal-requested author--year math/physical-sciences reference route.
% This file still requires external human review and compile/log/page audit.
...
\title[Dual General Position in a Complete-Graph--Tree Join]
{Dual General Position in the Join of a Complete Graph and a Tree}

\author*[1]{\sur{Yi} \fnm{Yuteng}}
\email{yiyuteng29@163.com}
...
\keywords{dual general position, graph join, tree, graph convexity,
dynamic programming}

\pacs[MSC Classification]{05C12 (primary), 05C05, 05C69, 05C76, 05C85}
...
\bibitem[Chandran et al.(2026)]{chandran-et-al-survey}
...
\bibitem[Dokyeesun et al.(2026)]{dokyeesun-et-al-products}
...
\bibitem[Ghorbani et al.(2021)]{ghorbani-et-al-operations}
...
\bibitem[Jiang(2026)]{jiang-complete-first-factor}
...
\bibitem[Tian and Klav\v{z}ar(2025)]{tian-klavzar-variety}
...
\bibitem[Tian et al.(2026)]{tian-et-al-removal}
