% Initial-submission candidate for Graphs and Combinatorics, 29 August 2026.
% Derived from the frozen-content local v4 candidate without changing any
% theorem, proof, computation, citation, author statement, or limitation.
% Requires Springer's official SVJour3 package and the smallextended option.
...
\titlerunning{Dual General Position in a Complete-Graph--Tree Join}
\author{Yi Yuteng}
\authorrunning{Yi Yuteng}
\institute{Yi Yuteng \at
...
\keywords{dual general position \and graph join \and tree \and
graph convexity \and dynamic programming}
\subclass{05C12 (primary) \and 05C05 \and 05C69 \and 05C76 \and 05C85}
\end{abstract}
