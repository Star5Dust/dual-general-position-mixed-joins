% Versioned draft v5, 29 August 2026.
% Initial-submission candidate prepared for Discussiones Mathematicae Graph
% Theory (DMGT). The frozen, externally compiled v3 source and the reviewed
% v4 source are unchanged. This version incorporates the adjudicated minor
% corrections from four external AI review attempts. It still requires a
% real compile/log/page audit and does not claim human peer review.
