% Versioned draft v6, 29 August 2026.
% Initial-submission candidate prepared for Discussiones Mathematicae Graph
% Theory (DMGT). The frozen v3, v4, and v5 sources are unchanged. This
% version incorporates the adjudicated reproducibility and exposition
% revisions from a fifth external AI review. It does not claim human peer
% review.
...
instructions, and is provided with this manuscript as supplementary material.
...
audit outputs supporting the computational checks are provided with this
manuscript in \path{mixed_join_v6_reproducibility.zip}. Its SHA-256 checksum
is recorded in Section~\ref{sec:computation}.
